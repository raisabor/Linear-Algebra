...
class Plane(object):
    ...
    def __eq__(self, p):
        ...
        basepointDifference = x0.minus(y0) 
    ...
    def instersectionWIth(self, ell, pll):
        try:
           A, B = self.normal_vector.coordinates
           C, D = ell.normal_vector.coordinates
           E, F = pll.normal_vector.coordinates

           k1 = self.constant_term
           k2 = ell.constant_term
           k3 = pll.constant_term
           ...
           return Vector([x_numerator, y_numerator]).timeScalar(oneOverDenom)
